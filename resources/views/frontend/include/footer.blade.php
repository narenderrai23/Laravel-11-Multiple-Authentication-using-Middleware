<footer class="footer">
            ...
            <div class="row widgets footer-widgets">
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="single-widget widget-contact">
                        ...
                        <ul>
                            <li><b>Address :</b>A-327, Budha Marg Mandawali, Delhi-110092</li>
                            <li><b>Phone :</b><a href="#">+91 90134 02089</a></li>
                            <li><b>Email :</b><a href="#">info@healthback.in</a></li>
                        </ul>
    ...
    <div class="footer-bottomarea">
        <div class="container">
            <p class="footer-copyright">Copyright 2024 by <a href="#">Health Back</a>. All rights
                reserved</p>
        </div>
    </div>
</footer>