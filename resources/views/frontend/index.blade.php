...
@section('main')
    ...
    <main class="main-content">
        ...
        <div class="tm-section services-area tm-padding-section bg-white">
            <span class="bg-shape-left"><img data-pagespeed-lazy-src="assets/images/icons/bg-shape-1.png"
                    alt="background shape" src="pagespeed_static/1.JiBnMqyl6S.gif"
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-30">
                        <div class="tm-service text-center wow fadeInUp">
                            <div class="tm-service-inner">
                                ...
                                <h5><a href="service-details.html">Elder caretaker</a></h5>
                                <p>Lorem ipsum dolor sit amet, in quodsi vulputate pro. Ius illum vocent
                                    mediocritatem
                                    an cule dicta iriure at phaedrum.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-30">
                        <div class="tm-service text-center wow fadeInUp">
                            <div class="tm-service-inner">
                                ...
                                <h5><a href="service-details.html">Patient Care at Home</a></h5>
                                <p>Lorem ipsum dolor sit amet, in quodsi vulputate pro. Ius illum vocent
                                    mediocritatem
                                    an cule dicta iriure at phaedrum.</p>
                                <a href="#" class="tm-readmore">Read more</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-30">
                        <div class="tm-service text-center wow fadeInUp">
                            <div class="tm-service-inner">
                                ...
                                <h5><a href="service-details.html">Baby Care</a></h5>
                                <p>Lorem ipsum dolor sit amet, in quodsi vulputate pro. Ius illum vocent
                                    mediocritatem
                                    an cule dicta iriure at phaedrum.</p>
                                <a href="#" class="tm-readmore">Read more</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-30">
                        <div class="tm-service text-center wow fadeInUp">
                            <div class="tm-service-inner">
                                ...
                                <h5><a href="service-details.html">Nurses</a></h5>
                                <p>Lorem ipsum dolor sit amet, in quodsi vulputate pro. Ius illum vocent
                                    mediocritatem
                                    an cule dicta iriure at phaedrum.</p>
                                <a href="#" class="tm-readmore">Read more</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-30">
                        <div class="tm-service text-center wow fadeInUp">
                            <div class="tm-service-inner">
                                ...
                                <h5><a href="service-details.html">Doctor’s</a></h5>
                                <p>Lorem ipsum dolor sit amet, in quodsi vulputate pro. Ius illum vocent
                                    mediocritatem
                                    an cule dicta iriure at phaedrum.</p>
                                <a href="#" class="tm-readmore">Read more</a>
            ...
            <div class="container">
                <div class="tm-cta">
                    ...
                    <div class="tm-cta-button">
                        <a href="book-an-appointment.html" class="tm-button tm-button-white">Book an
                            Appointment</a>
                    </div>
                </div>
            </div>
